...
const FixtureRow: React.VFC<FixtureRowProps> = ({
  ...
  <Link href={`fixtures/${id}`}>
    <tr>
      <td className="w-1/2 px-2 py-5 text-sm bg-white border-b border-gray-200">
      ...
      <td className="px-0 py-5 text-sm bg-white border-b border-gray-200">
...
const FixturesTable: React.VFC<TableProps> = ({ fixtures }: TableProps) => (
  <div className="container px-2 py-8 mx-auto sm:px-8">
    <h3 className="px-6 font-semibold px text-l">Today</h3>
        ...
        <table className="min-w-full leading-normal">
          <thead>
            <tr>
              ...
              <th className="px-0 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">
                {/* Time */}
              </th>
              <th className="px-5 py-3 text-xs font-semibold tracking-wider text-center text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">
                Away
